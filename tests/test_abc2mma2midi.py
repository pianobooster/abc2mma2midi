...
from abc2mma2midi import Abc2Mma2Midi
...
@pytest.fixture
def abc2mma2midi(options):
    return Abc2Mma2Midi(options)
...
def command_line(abc2mma2midi, commands):
    abc2mma2midi.pass_args(commands)
...
def test_easy_abc2midi_emulation(options, abc2mma2midi):
